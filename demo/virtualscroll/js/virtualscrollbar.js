...
var __virtualScrollbar = function(options){
    ...
    ,virtual_bar_display = function(){
        if(status.mouseDown===false && status.mouseEnter===false && status.virtualbar_show===true){
            hide_virtual_bar();
        }else if(status.virtualbar_show===false){
            show_virtual_bar();
        }
    }
    ,show_virtual_bar = function(){
        status.virtualbar_show = true;
        self.virtualbar.style.opacity='1';
    }
    ,hide_virtual_bar = function(){
        status.virtualbar_show = false;
    ...
    */
    ...
    this.bind = function(target){
        ...
        if(options.autohide){
            this.virtualbar.style.transition = 'opacity .5s';
        ...
        addEvent(document, 'mousemove' ,this.thumbhandler.mousemove);
